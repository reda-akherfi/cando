"""
Project info dialog for the Cando application.

This module provides a simple dialog for displaying project information
...
class ProjectInfoDialog(BaseDialog):
    """
    Dialog for displaying project information in a read-only format.

    Shows project name, tags, and status in a simple, organized layout
    similar to the editing dialog but with only a close button.
    """

    def __init__(self, project: Project, parent=None):
        """
        Initialize the project info dialog.

        Args:
            project: Project to display information for
            parent: Parent widget
        """
        super().__init__(parent)
        self.project = project

        self.setWindowTitle(f"Project Info: {self.project.name}")
        self.setModal(True)
    ...
    def load_project_data(self):
        ...
        # Status
        self.status_edit.setText(self.project.status)
        self.priority_edit.setText(self.project.priority)
